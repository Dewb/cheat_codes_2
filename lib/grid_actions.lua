...
function grid_actions.perf_page(x,y,z)
...
function grid_actions.seq_page(x,y,z)
...
function grid_actions.delay_page(x,y,z)
...
function grid_actions.init(x,y,z)
  ...
  if params:string("grid_size") == "128" then
    ...
    if grid_page == 0 then
      grid_actions.perf_page(x,y,z)
    elseif grid_page == 1 then
      grid_actions.seq_page(x,y,z)
    elseif grid_page == 2 then
      grid_actions.delay_page(x,y,z)
    end
  ...
  elseif params:string("grid_size") == "256" then
    ...
    elseif grid_page == 0 then
      grid_actions.perf_page(x,y-8,z)
    elseif grid_page == 1 then
      grid_actions.seq_page(x,y-8,z)
    elseif grid_page == 2 then
      grid_actions.delay_page(x,y-8,z)
    end
